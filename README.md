...
| 담당 | 가이드 | 채울 문서 |
| --- | --- | --- |
| 한서연 (검증) | [docs/가이드_한서연_검증.md](docs/가이드_한서연_검증.md) | [docs/리포트_한서연_검증.md](docs/리포트_한서연_검증.md) |
| 최서영 (데이터) | [docs/가이드_최서영_데이터.md](docs/가이드_최서영_데이터.md) | [docs/리포트_최서영_데이터.md](docs/리포트_최서영_데이터.md) |
...
상시 운영(무료 호스팅)은 [docs/서버_배포.md](docs/서버_배포.md) 참고.
